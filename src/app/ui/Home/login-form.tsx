                ...
                <div className="max-w-sm space-y-3 m-auto">
                    <div className="">
                        ...
                        <div className="relative">
                            <input type="text" id="hs-leading-icon" name="email" className="py-3 px-4 ps-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Email" />
                        ...
                        <div className="relative">
                            <input type="password" id="hs-leading-icon" name="password" className="mt-3  py-3 px-4 ps-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Password" />
                            <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
