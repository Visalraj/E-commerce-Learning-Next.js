...
const iconNames = ['edit', 'delete', 'loginbyadmin', 'userstatus', 'Home', 'Wishlist', 'SignOut', 'Briefcase', 'Purchase', 'Arrowright', 'Search'];
...
export default function Icon({ name }: { name: IconName }) {
    const icons: Record<IconName, JSX.Element> = {
        ...
        loginbyadmin: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 hover:text-green-600" style={{ transform: "scale(-1, 1" }}>
